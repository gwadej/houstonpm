...
convert:
	ttree --define year=2012 -f _ttreerc about.tt2 faqs.tt2 index.tt2 meetings.tt2 remote_meetings.tt2 projects/index.tt2 projects/delcom_vsi/index.tt2 projects/net_jabber_bot/index.tt2
